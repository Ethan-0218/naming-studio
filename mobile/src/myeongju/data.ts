...
export const SIJAN: Sijan[] = [
  { name: '자시', hanja: '子', hanjaFull: '子時', range: '오후 11:00 – 오전 1:00', startHour: 23 },
  { name: '축시', hanja: '丑', hanjaFull: '丑時', range: '오전 1:00 – 오전 3:00',  startHour: 1  },
  { name: '인시', hanja: '寅', hanjaFull: '寅時', range: '오전 3:00 – 오전 5:00',  startHour: 3  },
  { name: '묘시', hanja: '卯', hanjaFull: '卯時', range: '오전 5:00 – 오전 7:00',  startHour: 5  },
  { name: '진시', hanja: '辰', hanjaFull: '辰時', range: '오전 7:00 – 오전 9:00',  startHour: 7  },
  { name: '사시', hanja: '巳', hanjaFull: '巳時', range: '오전 9:00 – 오전 11:00', startHour: 9  },
  { name: '오시', hanja: '午', hanjaFull: '午時', range: '오전 11:00 – 오후 1:00', startHour: 11 },
  { name: '미시', hanja: '未', hanjaFull: '未時', range: '오후 1:00 – 오후 3:00',  startHour: 13 },
  { name: '신시', hanja: '申', hanjaFull: '申時', range: '오후 3:00 – 오후 5:00',  startHour: 15 },
  { name: '유시', hanja: '酉', hanjaFull: '酉時', range: '오후 5:00 – 오후 7:00',  startHour: 17 },
  { name: '술시', hanja: '戌', hanjaFull: '戌時', range: '오후 7:00 – 오후 9:00',  startHour: 19 },
  { name: '해시', hanja: '亥', hanjaFull: '亥時', range: '오후 9:00 – 오후 11:00', startHour: 21 },
];
