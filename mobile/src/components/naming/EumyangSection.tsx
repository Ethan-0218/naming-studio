...
import { Eumyang, EumyangHarmonyResult, NameInput } from '@/naming-tool/types';
import { getEumyangCombinationDescription } from '@/naming-tool/domain/eumyangCombinationDescriptions';
