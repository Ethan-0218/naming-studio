...
class Test오행조화_두글자(unittest.TestCase):
    ...
    def test_상극_불조화(self):
        # 목극금 (금극목) → 알고리즘 大凶 → total_score 0.0
